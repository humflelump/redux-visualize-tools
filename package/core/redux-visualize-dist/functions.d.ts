...
export declare function getType(f: any): constants.NODE_TYPES.RESELECT_SELECTOR | constants.NODE_TYPES.ASYNC_SELECTOR | constants.NODE_TYPES.CONNECT | constants.NODE_TYPES.CLASS_COMPONENT | constants.NODE_TYPES.FUNCTION_COMPONENT | constants.NODE_TYPES.FUNCTION | "UNKNOWN";
