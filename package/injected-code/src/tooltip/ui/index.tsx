...
function makeBubble(dimensions: {
  width: number;
  height: number;
  showOnRight: boolean;
}) {
  ...
  return `M19,1 L${W - 10},1 a9,9 0 0,1 9,9 L${W - 1},${H -
    10} a9,9 0 0,1 -9,9 L20,${H - 1} a9,9 0 0,1 -9,-9 L10,${H / 2 + 5} L0,${H /
    2} L10,${H / 2 - 5} L10,10 a9,9 0 0,1 9,-9`;
}
...
class Component extends React.Component<Props> {
  public render() {
    ...
    return (
      <div className={props.classes.container} style={props.dimensions}>
        ...
        >
          <div className={props.classes.title}>{props.node.data.name}</div>
          <Divider />
